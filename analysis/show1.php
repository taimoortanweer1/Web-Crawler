...
$query=mysql_query("INSERT INTO info(link,senti_score,title,senti_type) VALUES('$url','$score','$title','$type')");
if($query){
...
//echo "An error occurred!";
 ...
 //Insert Data into mysql
$query=mysql_query("INSERT INTO info(link,senti_score,title,senti_type) VALUES('$url','0','$title','positive')");
if($query){
//echo "Data inserted successfully!";
}
else{
